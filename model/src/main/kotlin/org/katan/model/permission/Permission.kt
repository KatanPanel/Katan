package org.katan.model.permission
 ...
 * When these roles are attached to permissions holder, they grant or revoke specific privilegies
 ...
 *
 * ## Inheritance & Sync
 * Roles inherit permission from the parent unit (the unit they were created in).
 * Any changes to a parent unit will be reflected in its roles.
 */
